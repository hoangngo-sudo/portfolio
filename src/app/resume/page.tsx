  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center bg-dark-bg px-[5%] pt-24 pb-32">
      ...
      >
        ...
        >
          <IconUndo2FillDuo18 className="size-5" aria-hidden="true" />
          Back
        </MotionLink>
      </motion.div>
      ...
      {error ? (
        ...
        <>
          {/* A4: 210mm × 297mm. Matches exact print dimensions on screen + PDF export. */}
          <style>{`@page { size: A4; margin: 0; }`}</style>
          <div
            className="mx-auto w-[210mm] min-h-[297mm] rounded-sm bg-white
              ...
              [&_.right]:text-right
              [&_ul]:m-0 [&_ul]:pl-[18pt] [&_ul]:list-disc
          ...
          <motion.a
            ...
            style={{ transition: "background-color 150ms ease, color 150ms ease" }}
          >
            <IconFileDownloadFillDuo18 className="size-5" aria-hidden="true" />
            Download
          </motion.a>
        </>
      )}
