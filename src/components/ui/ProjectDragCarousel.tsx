    ...
    >
      {items.map((project) => (
        <SpotlightCard
          ...
          className="group flex w-75 shrink-0 flex-col rounded-xl bg-card-bg p-5 dm-elevation-2 transition-transform duration-150 ease-out active:scale-[0.97] md:w-80 lg:w-80"
